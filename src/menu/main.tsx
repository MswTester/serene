        ...
        menuPage, setMenuPage,
        }}>
            {
                menuPage === "main" ? <div className="w-full h-full bg-cover text-white bg-black bg-center flex flex-col justify-center items-center space-y-7 overflow-hidden" style={{backgroundImage: `url(assets/mainbg.png)`}}>
                    ...
                    <button onClick={e => setMenuPage("single")} className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 bg-[#ffffff] text-black font-semibold shadow-md shadow-black" style={{width:'30%', minWidth:'100px', maxWidth:'400px'}}>Single</button>
