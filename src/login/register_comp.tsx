...
export default function Index() {
    ...
    return (<>
        <div className="w-full h-full text-card-foreground shadow-sm bg-[#000000] flex justify-center items-center flex-col text-white bg-cover bg-center" data-v0-t="card" style={{backgroundImage: `url(assets/loginbg.png)`}}>
